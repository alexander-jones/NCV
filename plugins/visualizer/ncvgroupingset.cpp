...
void NCVGroupingSet::bind(NCSElementType type,QGLXCamera camera,bool deselected)
{
    if (type == Neuron)
...
void NCVGroupingSet::bindSilhouettes(NCSElementType type,QGLXCamera camera)
{
...
void NCVGroupingSet::draw(NCSElementType type)
{
    m_dirty = false;
    for (QVector<NCVConvexHull>::iterator it = m_columnHulls.begin(); it != m_columnHulls.end(); it ++ )
		m_draw(type,*it);
...
void NCVGroupingSet::drawSubset(NCSElementType type,int startElement, int count)
{
    m_dirty = false;
	for (QVector<NCVConvexHull>::iterator it = m_columnHulls.begin(); it != m_columnHulls.end(); it ++ )
...
void NCVGroupingSet::release(NCSElementType type)
{
    if (type == Neuron)
...
void NCVGroupingSet::releaseSilhouettes(NCSElementType type)
{
...
void NCVGroupingSet::m_draw(NCSElementType type, NCVConvexHull hull)
{
	if (hull.show)
	{
		if (type == Grouping )
...
void NCVGroupingSet::m_drawSubset(NCSElementType type,int startElement, int count, NCVConvexHull hull)
{
